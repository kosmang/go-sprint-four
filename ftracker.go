...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	...
	spentCalories := ((runningCaloriesMeanSpeedMultiplier * runningMeanSpeed * runningCaloriesMeanSpeedShift) * weight / mInKm * duration * minInH)
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	...
	meanSpeed := math.Pow(walkingMeanSpeed, 2)
	spentCalories := ((walkingCaloriesWeightMultiplier*weight + (meanSpeed/(height/cmInM))*walkingSpeedHeightMultiplier*weight) * duration * minInH)
	return spentCalories
}
...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
	...
	spentCalories := (meanSpeed + swimmingCaloriesMeanSpeedShift) * swimmingCaloriesWeightMultiplier * weight * duration
	return spentCalories
}
